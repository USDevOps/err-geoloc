...
class Geoloc(BotPlugin):
    ...
    def geoloc_set(self, msg, args):
        ...
        """
        if hasattr(msg.to, 'topic'): #Check if the bot is in a chatroom or not
            yield("Please contact me directly in a private conversation")
        else:
